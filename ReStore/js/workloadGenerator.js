...
function generateWorkload(){
    ...
    var endPageId = highestPageId; // Using tier3Size as the total number of pages for workload generation
...
$(document).ready(function(){
    ...
    const smallWorkload1 = [100, 5000, 100, 80, 15, 60];
    const smallWorkload2 = [100, 5000, 100, 80, 15, 60];
    const smallWorkload3 = [100, 5000, 100, 80, 15, 90];
    const smallWorkload4 = [100, 5000, 100, 80, 15, 20];
    const smallWorkload5 = [100, 5000, 100, 95, 5, 60];
    const smallWorkload6 = [100, 5000, 100, 100, 100, 60];
    const smallCustomWorkload = [100, 5000, 100, 80, 15, 40]; // Placeholder for custom workload, will be updated with user inputs

    const pciSSD = [12.4, 3.0, 6]; // PCI
    const sataSSD = [100, 1.5, 9]; // SATA
    const optaneSSD = [6.8, 1.1, 5]; // Optane
    const virtualSSD = [180, 2.0, 19]; // Virtual
    ...
    var workloads = [smallWorkload1, smallWorkload2, smallWorkload3, smallWorkload4, smallWorkload5, smallWorkload6, smallCustomWorkload];
...
$(document).on("change", "#device1, #device2, #device3, #cmp_device_rw, #cmp_device_bp", function() {
